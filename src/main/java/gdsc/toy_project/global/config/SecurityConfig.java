...
import gdsc.toy_project.global.security.CustomAuthenticationEntryPoint;
import gdsc.toy_project.global.security.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationConfiguration authenticationConfiguration) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/user/signUp", "/user/signIn","/user/checkUid").permitAll()  // 이 api를 허락한다
